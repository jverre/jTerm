...
class Container(widget.Widget):
    ...
    def layout(self, available: layout.Rect):
        ...
        for child in self.children:
            size = child.height if self.direction == layout.DirectionMode.VERTICAL else child.width
        ...
        total_space = self.rect.height if self.direction == layout.DirectionMode.VERTICAL else self.rect.width
